...
function PricingPage() {
  ...
  return (
    ...
    >
      ...
      <link
        href="https://fonts.googleapis.com/css2?family=Roboto+Flex:opsz,wght@8..144,300..900&display=swap"
        rel="stylesheet"
      />
      ...
      <section className="max-w-xl mx-auto px-4 pb-20">
        ...
        >
          <div className="absolute inset-0 opacity-25 pointer-events-none">
            <div
              className="absolute top-0 left-1/4 w-64 h-64 rounded-full blur-[100px]"
          ...
          <div className="relative">
            ...
            <h2 className="text-3xl sm:text-4xl font-black tracking-tight mb-8">
              One complete video production pack.
            </h2>
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                {
                  icon: FileText,
                  label: "Script + voiceover dialogue",
                  body: "ElevenLabs-ready text, paced and formatted.",
                },
                {
                  icon: ImageIcon,
                  label: "Beat-by-beat visual plan",
                  body: "Detailed 9:16 image & video prompts for every scene.",
                },
                {
                  icon: Sparkles,
                  label: "Thumbnail system",
                  body: "One production-ready 9:16 prompt plus two fast alternate directions.",
                },
                {
                  icon: Mic,
                  label: "Voice direction",
                  body: "Tone, pace, emotion, pauses — ready to record.",
                },
                {
                  icon: Hash,
                  label: "Caption + hashtags",
                  body: "Platform-optimised post-ready text.",
                },
                {
                  icon: BookOpen,
                  label: "Source-backed research",
                  body: "Every claim backed by a cited URL.",
                },
              ].map((item) => (
                <div key={item.label} className="flex gap-3">
                  ...
                  <div>
                    <div className="font-bold text-sm" style={{ color: "hsl(var(--background))" }}>
                      {item.label}
                    </div>
                    <div
        ...
        <div className="mt-16 max-w-2xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              {
                q: "Do credits expire?",
                a: "Never. Credits sit in your wallet until you use them. There's no monthly reset or expiry.",
              },
              {
                q: "What counts as a 'tweak'?",
                a: "After your first message in a chat, each follow-up message is a tweak. The first 3 tweaks per chat are free. After that, 1 credit per tweak.",
              },
              {
                q: "Can I use credits across multiple chats?",
                a: "Yes. Your credit balance is shared across all your chats and scripts.",
              },
              {
                q: "Is there a subscription?",
                a: "No. Vidzo is strictly credit-based. Buy when you need, stop when you don't.",
              },
              {
                q: "What payment methods are accepted?",
                a: "UPI, debit/credit cards via Razorpay. Payment integration coming very soon.",
              },
            ].map(({ q, a }) => (
